...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'ps7-demo', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\www\\ps7-demo\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'C:\\laragon\\www\\ps7-demo\\modules\\productcomments\\src\\Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\www\\ps7-demo\\modules\\ps_checkout\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\laragon\\www\\ps7-demo\\modules\\ps_checkout\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\www\\ps7-demo\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\laragon\\www\\ps7-demo/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_eac18b1a9cb86c902eda03342e09cbe324dbd5b657a6398706464b08c65fa9fd');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\www\\ps7-demo/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\www\\ps7-demo/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.4', 'C:\\laragon\\www\\ps7-demo');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\laragon\\www\\ps7-demo/app',
            'kernel.project_dir' => 'C:\\laragon\\www\\ps7-demo',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\laragon\\www\\ps7-demo/var/cache/prod\\',
            'kernel.active_modules' => [
                ...
                79 => 'ht_scrolltop',
                80 => 'ht_staticblocks',
                81 => 'ht_googleanalytics',
                82 => 'ps_searchbarjqauto',
            ],
            'ps_cache_dir' => 'C:\\laragon\\www\\ps7-demo/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\laragon\\www\\ps7-demo/var/cache/prod\\/doctrine/orm/Proxies',
