...
{if $page.page_name == 'index'}
    {if $homeslider.slides}
        ...
        <div id="carousel" class="mb-5 carousel slick__arrow-large" {if $homeslider.slides|count > 1}data-slick={strip}
        '{literal}{
    "autoplay": true,
    "slidesToShow": 1,
                ...
                <a href="{$slide.url}">
                        ...
                        {if $slide.title || $slide.description}
                            <div class="slider-caption">
                                <p class="display-1 text-uppercase bebas">{$slide.title}</p>
